...
namespace Lykke.Service.MaintenanceMode
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "MaintenanceModeLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.MaintenanceModeService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("MaintenanceMode", channelOptions =>
                        {
